    ...
    return (
      <main className="pic-bg" id="about">
        ...
        <div className="about text-bigger">
          ...
          <p>I pride myself in my attention to detail, problem solving persistence, and ability to adapt to any environment. When I'm not coding, I try to enjoy the simple things in life, like making someone laugh unexpectedly, trying a new restaurant, or a well-crafted dad joke. 
          </p>
        </div>
      </main>
    );
